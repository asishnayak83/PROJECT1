...
main_application.title('Astar Texteditor')
...
font_color_btn = ttk.Button(tool_bar, image=color_icon)
font_color_btn.grid(row=0, column=5,padx=5)

## align left 
'''align_left_icon = tk.PhotoImage(file='icons2/align_left.png')'''
align_left_btn = ttk.Button(tool_bar, text='align_left')
align_left_btn.grid(row=0, column=6, padx=5)

## align center 
'''align_center_icon = tk.PhotoImage(file='icons2/align_center.png')'''
align_center_btn = ttk.Button(tool_bar, text='align_center')
align_center_btn.grid(row=0, column=7, padx=5)

## align right 
'''align_right_icon = tk.PhotoImage(file='icons2/align_right.png')'''
align_right_btn = ttk.Button(tool_bar, text='align_right')
